...
public class Movie4Activity extends YouTubeBaseActivity implements View.OnClickListener, YouTubePlayer.OnInitializedListener {

    private static final String MOVIE = "movie4";
    private static final String FAVORITE_MOVIES = "favorite";
    private static final String ID_YOUTUBE_MOVIE_1 = "upPNjcQXw-s";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wbvDescription.loadUrl("file:///android_asset/Movie4Description.html");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ibtnPoster:
                startActivity(new Intent(Movie4Activity.this, Movie4PosterActivity.class));
                finish();
                break;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Movie4Activity.this, MainActivity.class));
        finish();
    }
