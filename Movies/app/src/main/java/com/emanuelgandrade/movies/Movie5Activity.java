...
public class Movie5Activity extends YouTubeBaseActivity implements View.OnClickListener, YouTubePlayer.OnInitializedListener {

    private static final String MOVIE = "movie5";
    private static final String FAVORITE_MOVIES = "favorite";
    private static final String ID_YOUTUBE_MOVIE_1 = "UlG7mv2Nh-U";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wbvDescription.loadUrl("file:///android_asset/Movie5Description.html");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ibtnPoster:
                startActivity(new Intent(Movie5Activity.this, Movie5PosterActivity.class));
                finish();
                break;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Movie5Activity.this, MainActivity.class));
        finish();
    }
