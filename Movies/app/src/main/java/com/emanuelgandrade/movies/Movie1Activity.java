...
public class Movie1Activity extends YouTubeBaseActivity implements View.OnClickListener, YouTubePlayer.OnInitializedListener {

    private static final String MOVIE = "movie1";
    private static final String FAVORITE_MOVIES = "favorite";
    private static final String ID_YOUTUBE_MOVIE_1 = "FCe8NDiTxDM";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ibtnPoster:
                startActivity(new Intent(Movie1Activity.this, Movie1PosterActivity.class));
                finish();
                break;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Movie1Activity.this, MainActivity.class));
        finish();
    }
