...
public class Movie2Activity extends YouTubeBaseActivity implements View.OnClickListener, YouTubePlayer.OnInitializedListener {

    private static final String MOVIE = "movie2";
    private static final String FAVORITE_MOVIES = "favorite";
    private static final String ID_YOUTUBE_MOVIE_1 = "FRLYZn5PGuA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wbvDescription.loadUrl("file:///android_asset/Movie2Description.html");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ibtnPoster:
                startActivity(new Intent(Movie2Activity.this, Movie2PosterActivity.class));
                finish();
                break;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Movie2Activity.this, MainActivity.class));
        finish();
    }
