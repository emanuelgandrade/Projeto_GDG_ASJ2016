...
public class Movie6Activity extends YouTubeBaseActivity implements View.OnClickListener, YouTubePlayer.OnInitializedListener {

    private static final String MOVIE = "movie6";
    private static final String FAVORITE_MOVIES = "favorite";
    private static final String ID_YOUTUBE_MOVIE_1 = "uMXZIxLRMFU";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wbvDescription.loadUrl("file:///android_asset/Movie6Description.html");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ibtnPoster:
                startActivity(new Intent(Movie6Activity.this, Movie6PosterActivity.class));
                finish();
                break;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Movie6Activity.this, MainActivity.class));
        finish();
    }
